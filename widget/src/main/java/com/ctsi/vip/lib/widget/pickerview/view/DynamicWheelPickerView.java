package com.ctsi.vip.lib.widget.pickerview.view;
...
import com.ctsi.vip.lib.widget.R;
import com.ctsi.vip.lib.widget.pickerview.adapter.ArrayWheelAdapter;
import com.ctsi.vip.lib.widget.pickerview.adapter.MultiWheelAdapter;
import com.ctsi.vip.lib.widget.pickerview.configure.PickerOptions;
import com.ctsi.vip.lib.widget.pickerview.entity.IDynamicWheelItem;
import com.ctsi.vip.lib.widget.pickerview.listener.DynamicWheelSelectListener;
import com.ctsi.vip.lib.widget.wheelview.listener.OnItemSelectedListener;
import com.ctsi.vip.lib.widget.wheelview.view.WheelView;
...
public class DynamicWheelPickerView<T extends IDynamicWheelItem> extends BasePickerView
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.pickerview_multiple, contentContainer);
