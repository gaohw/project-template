...
import com.ctsi.vip.lib.widget.richtext.CacheType;
...
import com.ctsi.vip.lib.widget.richtext.drawable.DrawableSizeHolder;
import com.ctsi.vip.lib.widget.richtext.drawable.DrawableWrapper;
import com.ctsi.vip.lib.widget.richtext.ext.Base64;
import com.ctsi.vip.lib.widget.richtext.ext.TextKit;
...
import static com.ctsi.vip.lib.widget.richtext.ext.Debug.log;
...
public class DefaultImageGetter implements ImageGetter, ImageLoadNotify {
    ...
    private static final int TASK_TAG = R.id.default_image_tag_id;
